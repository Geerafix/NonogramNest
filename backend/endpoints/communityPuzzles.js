...
server.get('/communityPuzzles', asyncHandler(async (req, res) => {
...
server.get('/communityPuzzle', asyncHandler(async (req, res) => {
...
server.post('/created', asyncHandler(async (req, res) => {
