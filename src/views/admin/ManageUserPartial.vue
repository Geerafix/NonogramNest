...
import {getUserChallengeScores, getUserClassicScores, getUserCreatedPuzzles} from "@/services/adminService.js";
...
const {pageState, pageReset} = usePagination(1, scoresList);
...
<template>
  <TransitionGroup name="fade" mode="out-in" tag="div">
    ...
    <List v-if="!isScoresEmpty" v-bind="listState" class="!absolute top-0" key="2"/>
